...
1) Delete the last column of the file that did not have any data (NaN values).
2) Replace " " space character by "_" underline in file column names. For example, "concave points_mean" was replaced by "concave_points_mean".
